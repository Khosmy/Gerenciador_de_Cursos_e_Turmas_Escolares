...
from models import TurmaDisciplina_HorarioProfessor
...
class AdminTurmaDisciplina_HorarioProfessor(admin.ModelAdmin):
...
admin.site.register(TurmaDisciplina_HorarioProfessor, AdminTurmaDisciplina_HorarioProfessor)