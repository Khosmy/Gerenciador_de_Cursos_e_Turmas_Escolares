    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alunoSexo', models.CharField(max_length=1, null=True, verbose_name=b'Sexo', choices=[(b'M', b'M'), (b'F', b'F')])),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('cursoNome', models.CharField(max_length=50, null=True, verbose_name=b'Nome')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('disciplinaNome', models.CharField(max_length=80, null=True, verbose_name=b'Nome')),
                ('disciplinaDescricao', models.CharField(max_length=80, null=True, verbose_name=b'Descri\xc3\xa7\xc3\xa3o da Disciplina')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('professorNome', models.CharField(max_length=80, null=True, verbose_name=b'Nome do Professor')),
                ('professorFormacao', models.CharField(max_length=80, null=True, verbose_name=b'Forma\xc3\xa7\xc3\xa3o')),
                ('professorSexo', models.CharField(max_length=1, null=True, verbose_name=b'Sexo', choices=[(b'M', b'M'), (b'F', b'F')])),
            ],
            options={
            },
            bases=(models.Model,),
